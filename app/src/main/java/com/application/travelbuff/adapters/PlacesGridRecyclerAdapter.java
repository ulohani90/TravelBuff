 ...
 */
public class PlacesGridRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PlacesGridRecyclerAdapter(Context context,int height) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(getItemViewType(position) == TYPE_PLACE){
                ...
                holderPlace.placeImage.setImageBitmap(CommonLib.getBitmap(context,R.drawable.place_dummy,height,height));
            }
    }
